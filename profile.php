...
<body>
    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <!--==================== Left Section =================-->
                    <div class="left col-12 col-sm-0 col-md-0 col-lg-1 col-xl-1 col-xxl-1">
                        ...
                        <aside class="sidenav" id="leftnav">
                            ...
                            <a href="profile.php" class="profile shadow-sm d-none" id="sideprofile">
                                <div class="logo-profile-photo">
                                <?php $ProfilePic = new Profile();
                                $GetProfilePic = $ProfilePic->GetUserProfPic();
                                if(sizeof($GetProfilePic[0]['picname']) > 0){
                                foreach($GetProfilePic as $profpic){ ?>
                                    <img src="uploads/<?php echo $profpic['picname']; ?>" width="45" height="45" class="user-dp">
                                <?php }}
                                else{?>
                                    <img src="images/pp.png" class="user-dp">
                                <?php }?>
                ...
                <!--==================== Middle Section =================-->
                    <div class="middle col-12 col-sm-12 col-md-12 col-lg-11 col-xl-11 col-xxl-11">
                    ...
                    <!---Profile--->
                            <div class="col">
                                <div class="profile-cover">
                                    <div class="btn-cover-upload d-flex justify-content-center">
                                        <input type="file" class="btn upload-user-input" data-oldcoverpic="<?php echo $_SESSION['coverpic'];?>" data-userid="<?php echo $_SESSION['userid'] ?>" name="buttonCoverPhoto" id="btn_cover_upload" hidden/>
                                        <label class="btn upload-user-btn" for="btn_cover_upload"><i class="bi bi-camera-fill" id="dp_user_btn"></i></label>
                                    </div>
                                    
                                    <?php $CoverPic = new Profile();
                                    $GetCoverPic = $CoverPic->GetUserCoverPic();
                                    if(isset($GetCoverPic)){
                                        foreach($GetCoverPic as $coverpic){ ?>
                                        <img src="uploads/<?php echo $coverpic['picname']; ?>" class="user-cover">
                                    <?php }}
                                    else{?>
                                            <img src="images/logobanner.png" class="user-cover">
                                    <?php }?>
                                </div>
                                <div class="row user-pic">
                                    <div class="col-lg-5 col-md-4 profile-card">
                                        <div class="row d-flex justify-content-end" id="user-id-container">
                                            <div class="col-lg-3 col-xl-3 col-md-3 user-profile-picture col-sm-12" id="profile-dp">
                                                <?php $ProfilePic = new Profile();
                                                    $GetProfilePic = $ProfilePic->GetUserProfPic();
                                                ...
                                                <div class="dp-upload-btn">
                                                    <input type="file" class="btn prof-photo" data-oldprofpic="<?php echo $_SESSION['profpic'];?>" data-userid="<?php echo $_SESSION['userid'] ?>" name="buttonProfPhoto" id="prof_pic_input" hidden/>
                                                    <label class="btn dp-user-btn" for="prof_pic_input"><i class="bi bi-camera-fill" id="dp_user_btn"></i></label>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-xl-3 col-md-5 col-sm-12" id="user-id">
                                            <?php $UserInfo = New Profile();
                                                $GetUserInfo = $UserInfo->GetUserInfo();
                                                foreach($GetUserInfo as $row){
                                                ?>
                                                <h2 class="user-profile-name fw-bold"><?php echo $row['firstname'].' '.$row['lastname']; ?></h2>
                                            <?php }?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-sm-12">
                                            <div class="about card shadow">
                                                <div class="profile-card-title container">
                                                    <h2>About</h2>
                                                </div>
                                                <hr>
                                                <div class="about-icons">
                                                    <div class="about-items">
                                                        <i class="bi bi-envelope"> <?php echo $_SESSION['email'];?></i>
                                                    </div>
                                                    <div class="about-items">
                                                        <i class="bi bi-balloon"> <?php echo $_SESSION['birthday'];?></i>
                                                    </div>
                                                    <div class="about-items">
                                                        <i class="bi bi-gender-ambiguous"> <?php echo $_SESSION['gender'];?></i>
                                                    </div>
                                                    <div class="about-items">
                                                        <i class="bi bi-telephone"> <?php echo $_SESSION['phonenumber'];?></i>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="photos shadow card mt-3 mb-2">
                                                <div class="profile-card-title container mx-2 mt-2">
                                                    <h2>Photos</h2>
                                                </div>
                                                <hr>
                                                <?php $UserPhotoPosts = new Profile();
                                                    $GetUserPhotoPosts = $UserPhotoPosts->GetUserPhotoPosts();
                                                ?>
                                                <div class="photo-list">

                                                    <ul id="lightGallery" class="user-photo mb-3 gallery">
                                                    <!-- <div class="col-photos gallery " id="lightGallery"> -->

                                                    <?php foreach($GetUserPhotoPosts as $GetUserPhotoPost){?>
                                                        <li data-title="<?php echo $GetUserPhotoPost['picname'];?>" data-desc="<?php echo $GetUserPhotoPost['picname'];?>" data-responsive-src="uploads/<?php echo $GetUserPhotoPost['picname'];?>" data-src="uploads/<?php echo $GetUserPhotoPost['picname'];?>">
                                                            <a href="#">    
                                                                <img src="uploads/<?php echo $GetUserPhotoPost['picname'];?>" class="user-upload-photo me-1 mt-2">
                                                            </a>    
                                                        </li>
                                                    <?php }?>
                                                    <!-- </div> -->
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <?php
                                            $ProfilePost = new Profile();
                                            $GetUserPosts = $ProfilePost->GetUserPost();
                                            foreach($GetUserPosts as $GetUserPost){
                                            if(isset($GetUserPost['pid'])){?>
                                            <div class="profile-post shadow card">
                                                <div class="user-post">
                                                    ...
                                                    <a href="" class="user-direct-profile">
                                                        <h5 class="user-post-name"><?php echo $GetUserPost['firstname'].' '.$GetUserPost['lastname']; ?></h5>
                                                    </a>
                                                    &nbsp; -  &nbsp;<p class="text-muted mt-2"><?php echo $GetUserPost['dateposted'];?></p>
                                                    <div class="post-editor">
                                                        <button class="btn edit-update-post" data-postid= "<?php echo $GetUserPost['pid'];?>" data-postuserid="<?php echo $GetUserPost['userid'];?>" data-picname = "<?php echo $GetUserPost['postpicname'];?>"><i class="bi bi-pencil"></i></button>
                                                        <button class="btn delete-user-post" data-postid= "<?php echo $GetUserPost['pid'];?>" data-postuserid="<?php echo $GetUserPost['userid'];?>" data-picname = "<?php echo $GetUserPost['postpicname'];?>"><i class="bi bi-x-circle"></i></button>
                                                    </div>
                                                </div>
                                                <div class="post-content">
                                                    <div class="post-title">
                                                        <input type="text" class="edit-title-post" id="edit-title-post-<?php echo $GetUserPost['pid'];?>" value="<?php echo $GetUserPost['body']; ?>" hidden/>
                                                        <input type="text" id="old-title-post-<?php echo $GetUserPost['pid'];?>" value="<?php echo $GetUserPost['body']; ?>"  hidden/>
                                                        <h3 class="user-post-title" id="user-post-title-<?php echo $GetUserPost['pid'];?>"><?php echo $GetUserPost['body']; ?></h3> <p>-<i class="bi bi-geo-alt"></i><?php echo $GetUserPost['postlocation']; ?></p>
                                                    </div>
                                                    <div class="post-body">
                                                    <input type="file" class="btn img-edit-post-input" name="buttonEditPhoto" id="img_edit_post_<?php echo $GetUserPost['pid']; ?>" hidden/>
                                                            <label class="btn img-edit-post" for="img_edit_post_<?php echo $GetUserPost['pid']; ?>" id="img-edit-post-<?php echo $GetUserPost['pid'];?>" hidden><i class="bi bi-camera-fill"></i></label>
                                                        <?php if(isset($GetUserPost['postpicname'])){?>
                                                            <img src="uploads/<?php echo $GetUserPost['postpicname'];?>" class="post-user-pc">
                                                        <?php }?>
                                                    </div>
                                                    <div class="submit-comment">
                                                        <input type="text" class="comment-body" id="comment-body-<?php echo $GetUserPost['pid']; ?>" placeholder="Write comment here...">
                                                        <button type="submit" class="btn btn-sm comment-btn"  data-postid="<?php echo $GetUserPost['pid']; ?>" data-userid ="<?php echo $_SESSION['userid']; ?>">Submit</button>
                                                    </div>
                                                    <hr>
                                                    <?php 
                                                    $ProfileComments = new Profile();
                                                    $GetUserComments = $ProfileComments->GetUserComments();
                                                    foreach($GetUserComments as $GetUserComment){
                                                        if($GetUserPost['pid'] == $GetUserComment['postid']){
                                                        ?>
                                                            <div class="comment-content">
                                                                <div class="own-comment">
                                                                    <div class="user-comment">
                                                                        <img src="uploads/<?php echo $GetUserComment['picname'];?>" class="post-pic">
                                                                        <a href="" class="user-direct-profile">
                                                                            <h5 class="user-name2"><?php echo $GetUserComment['firstname'].' '.$GetUserComment['lastname']; ?></h5>
                                                                        </a>
                                                                    </div>
                                                                    <div class="user-comment-content">
                                                                        <p class="user-comment1">-<?php echo $GetUserComment['content']?></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    <?php }}?>
...
<!-- Modal Post Tag Location -->
    ...
    <script src="photos-controller.js"></script>

        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <!--==================== Middle Section =================-->
                    ...
                    foreach($GetUserInfo as $row){?>    
                    <div class="user-setting-profile card shadow">
                            <div class="first-name-setting">
                                <h4>First name:</h4>
                                <!-- <h5><?php echo $row['firstname'];?></h5> -->
                                <input type="text" id="new-first-name-edit" data-userid="<?php echo $row['id'];?>" hidden/>
                                <input type="text" id="old-first-name" value="<?php echo $row['firstname']; ?>" disabled/>
                            ...
                            <div class="last-name-setting">
                                ...
                                <input type="text" id="new-last-name-edit" data-userid="<?php echo $row['id'];?>" hidden/>
                                <input type="text" id="old-last-name" value="<?php echo $row['lastname']; ?>" disabled/>
                            ...
                            <div class="number-setting">
                                ...
                                <input type="number" id="new-phone-number-edit" data-userid="<?php echo $row['id'];?>" hidden/>
                                <input type="text" id="old-phone-number" value="<?php echo $row['phonenumber']; ?>" disabled/>
                                <button class="btn edit-phonenumber"><i class="bi bi-pencil"></i></button>
                            </div>
                            <hr>
                            <div class="birthday-setting">
                                <h4>Birthday:</h4>
                                <!-- <h5><?php echo $row['birthday'];?></h5> -->
                                <input type="text" id="new-birthday-edit" data-userid="<?php echo $row['id'];?>" hidden/>
                                <input type="text" id="old-birthday" value="<?php echo $row['birthday']; ?>" disabled/>
                                <button class="btn edit-birthday"><i class="bi bi-pencil"></i></button>
                            </div>
                        </div>
                        <?php }?>
                    </div>

                    ...
                    <!---Profile--->
                            <div class="col">
                                ...
                                <div class="btn-group shadow-sm">
                                        <a href="" class="btn user-direct-profile" data-userid="<?php echo $uid; ?>"> Profile</a>
                                        <a href="" class="btn user-direct-photos active" data-userid="<?php echo $uid; ?>">Photos</a>
                                        <a href="messages.php" class="btn user-direct-message" data-touserid="<?php echo $uid; ?>" data-fromuserid="<?php echo $_SESSION['userid']; ?>">Message</a>
                                </div>
                                <hr>
                                <div class="container">
                                    <div class="photos-uploads shadow card">
                                        <div class="galleries card">
                                            <h2>Gallery</h2>
                                            <?php $UserPhotos = new ViewProfile();
                                                $GetUserPhotos = $UserPhotos->ViewUserPhotos($uid);

...
<body>
    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <!--==================== Left Section =================-->
                    <div class="left col-12 col-sm-0 col-md-1 col-lg-1 col-xl-1 col-xxl-1">
                ...
                <!--==================== Middle Section =================-->
                    <div class="middle col-12 col-sm-12 col-md-11 col-lg-11 col-xl-11 col-xxl-11">
                    ...
                    <!---Profile--->
                            <div class="col">
                                <div class="profile-cover">
                                    ...
                                    <?php $CoverPic = new ViewProfile();
                                    $uid = $_GET['uid'];
                                    $GetCoverPic = $CoverPic->ViewUserCoverPic($uid);
                                ...
                                <div class="row user-pic">
                                    <div class="col-lg-5 col-md-4 profile-card">
                                        <div class="row d-flex justify-content-end">
                                            <div class="col-lg-3 col-md-3 user-profile-picture col-sm-12" id="profile-dp">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-12" id="user-id">
                                                <?php
                                                    $UserInfo = New ViewProfile();
                                                    $GetUserInfos = $UserInfo->ViewUserProfileInfo($uid);
                                                    foreach($GetUserInfos as $GetUserInfo){ ?>
                                                <h1 class="mt-5"><?php echo $GetUserInfo['firstname'].' '.$GetUserInfo['lastname']; ?></h1>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="btn-group shadow-sm">
                                        <a href="" class="btn user-direct-profile active" data-userid="<?php echo $uid; ?>"> Profile</a>
                                        <a href="" class="btn user-direct-photos" data-userid="<?php echo $uid; ?>">Photos</a>
                                        <a href="" class="btn user-direct-message" data-touserid="<?php echo $uid; ?>" data-fromuserid="<?php echo $_SESSION['userid']; ?>">Message</a>
                                </div>
                                <hr>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-5 col-sm-12">
                                            <div class="about card shadow">
                                                <h2>About</h2>
                                                <hr>
                                                <?php foreach($GetUserInfos as $GetUserInfo){ ?>
                                                <div class="about-icons">
                                                    <div class="about-items">
                                                        <i class="bi bi-envelope"> <?php echo $GetUserInfo['email'];?></i>
                                                    </div>
                                                    <div class="about-items">
                                                        <i class="bi bi-balloon"> <?php echo $GetUserInfo['birthday'];?></i>
                                                    </div>
                                                    <div class="about-items">
                                                        <i class="bi bi-gender-ambiguous"> <?php echo $GetUserInfo['gender'];?></i>
                                                    </div>
                                                    <div class="about-items">
                                                        <i class="bi bi-telephone"> <?php echo $GetUserInfo['phonenumber'];?></i>
                                                    </div>
                                                </div>
                                                <?php }?>
                                            </div>
                                            <div class="photos shadow card mt-3 mb-2">
                                                <h2>Photos</h2>
                                                <hr>
                                                <?php $UserPhotoPosts = new ViewProfile();
                                                    $GetUserPhotoPosts = $UserPhotoPosts->ViewUserPhotoPosts($uid);
                                                ?>
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <?php
                                            $ProfilePost = new ViewProfile();
                                            $GetUserPosts = $ProfilePost->ViewUserPost($uid);
                                            ...
                                            <div class="profile-post shadow card">
                                                <div class="user-post">
                                                    ...
                                                    <?php }?>
                                                    <a href="" data-userid="<?php echo $uid; ?>" class="user-direct-profile">
                                                        <h5 class="user-post-name"><?php echo $GetUserPost['firstname'].' '.$GetUserPost['lastname']; ?></h5>
                                                    </a>
                                                    &nbsp; -  &nbsp;<p class="text-muted"><?php echo $GetUserPost['dateposted'];?></p>
                                                            ...
                                                            <div class="comment-content">
                                                                <div class="own-comment">
                                                                    <div class="user-comment">
                                                                        ...
                                                                        <a href="" data-userid="<?php echo $GetUserComment['userid'];?>" class="user-direct-profile">

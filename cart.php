            ...
            <div class="row">
                    ...
                    <div class="col">
                                ...
                                <div class="btn-group shadow-sm">
                                        ...
                                        <a href="cart.php" class="btn active">Cart</a>
                                ...
                                <div class="cart-table">
                                    <table class="table">
                                        ...
                                        <tbody id="cart-info">
                                            <?php $Shop = New Shop();
                                                $GetCartLists = $Shop->GetCartLists();
                                                //print_r($GetCartLists);
                                                $total_amount = '';
                                                $grand_total = '';
                                                $total_qty = '';
                                                if(sizeof($GetCartLists) > 0){
                                                    foreach($GetCartLists as $row){
                                                        $total_amount =  $row['prodprice'] * $row['qty'];
                                                        $grand_total = $grand_total + $total_amount;
                                                        $total_qty = $total_qty + $row['qty'];
                                            ?>
                                            <tr class="cart-product">
                                                <th scope="row"><input type="checkbox"></th>
                                                <td data-title="Name"><p><?php echo $row['prodname']; ?></p></td>
                                                <td data-title="Image"><img class="product-img-profile" src="images/<?php echo $row['prodimg']; ?>"></td>
                                                <td data-title="Quantity"><?php echo $row['qty']; ?></td>
                                                <td data-title="Price"><?php echo $row['prodprice']; ?></td>
                                                <td data-title="Total"><?php echo number_format($total_amount,2); ?></td>
                                            </tr>
                                            
                                            <?php }}?>
                                        </tbody>
                                    </table>
                                    <div class="grandTotal">Grand Total: <?php echo number_format($grand_total,2); ?></div>
                                </div>
                                <div class="cart-order">
                                    <button type="submit" class="btn" id="btn-cart-order" data-bs-toggle="modal" data-bs-target="#buyNow">Checkout</button>
                                </div>

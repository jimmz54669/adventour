                    ...
                    <!---Profile--->
                            <div class="col">
                                ...
                                <div class="btn-group shadow-sm">
                                        ...
                                        <a href="orders.php" class="btn active">Orders</a>
                                </div>
                                <hr>
                                <div class="order-table">
                                    <table class="table">
                                        ...
                                        <tbody id="order-info">
                                        <?php $Shop = New Shop();
                                            $GetOrderLists = $Shop->GetOrderLists();
                                            // print_r($GetOrderLists);
                                            foreach($GetOrderLists as $row){
                                        ?>
                                            <tr class="order-product">
                                                <td data-title="Order ID" scope="row"><p><?php echo $row['orderid']; ?></p></td>
                                                <td data-title="Name"><?php echo $row['firstname'].' '.$row['lastname']; ?></td>
                                                <td data-title="Order address"><?php echo $row['orderaddress']; ?></td>
                                                <td data-title="Payment method"><?php echo $row['ordertype']; ?></span></td>
                                                <td data-title="Order Total"><?php echo $row['amount'];?></td>
                                                <td data-title="Status">Preparing Order</td>
                                                <td data-title="Remarks">
                                                    <button type="submit" class="btn OrderDetails" data-orderid="<?php echo $row['orderid']; ?>" id="btn-for-details" data-bs-toggle="modal" data-bs-target="#orderDetails">Order details</button>
                                                </td>
                                            </tr>
                                        <?php }?>
                                        </tbody>
    ...
    <div class="customize-theme">
        <div class="card">
            ...
            <!------ END OFFONT THEME COLORS ------->
                                    ...
                                    <div class="modal fade modal-xl" id="orderDetails">

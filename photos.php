                    ...
                    <!---Profile--->
                            ...
                            <div class="profile-cover">
                                ...
                                <div class="btn-group shadow-sm">
                                        ...
                                        <a href="photos.php" class="btn active">Photos</a>
                                        <a href="cart.php" class="btn">Cart</a>
                                        <a href="orders.php" class="btn">Orders</a>
                                </div>
                                <hr>
                                <div class="container">
                                    <div class="photos-uploads shadow card">
                                        <div class="galleries card">
                                            <h2>Gallery</h2>
                                            <?php $UserPhotos = new Profile();
                                                $GetUserPhotos = $UserPhotos->GetUserPhotos();
                                            if(sizeof($GetUserPhotos) > 0){
                                                ?>
                                                <div class="gallery-content">

                                                    <ul id="lightGallery" class="col-photos gallery">
                                                    <!-- <div class="col-photos gallery " id="lightGallery"> -->

                                                    <?php foreach($GetUserPhotos as $GetUserPhoto){?>
                                                        <li data-title="<?php echo $GetUserPhoto['picname'];?>" data-desc="<?php echo $GetUserPhoto['picname'];?>" data-responsive-src="uploads/<?php echo $GetUserPhoto['picname'];?>" data-src="uploads/<?php echo $GetUserPhoto['picname'];?>">
                                                            <a href="#">    
                                                                <img src="uploads/<?php echo $GetUserPhoto['picname'];?>" class="gallery-pic">
                                                            </a>    
                                                        </li>
                                                    <?php }?>
                                                    <!-- </div> -->
